...
quantile(Datasus_municipio_1$PIB_per_capita, probs = c(.333333,.666666))

Datasus_municipio <- Datasus_municipio %>% 
  ...
  select(mes, mun_cod, nome_municipio, nome_microrregiao, 
         ...
         PIB_per_capita, mais65, wealth, corona, regiao)
...
DataSus_x_cnes %>% 
  ...
  mutate(wealth = reorder(wealth, PIB, max)) %>% 
